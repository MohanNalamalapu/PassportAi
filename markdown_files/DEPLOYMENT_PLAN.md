...
PassportAI can be deployed in three different environments: locally, inside Docker containers, or hosted in cloud platforms (Render/Vercel).
...
4.  Set the **Environment Variables**:
    ...
    *   `MAX_UPLOAD_MB`: The file size limit in MB (default: 10).
